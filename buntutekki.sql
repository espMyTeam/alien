...
--
-- Client: localhost
-- Généré le : Jeu 03 Décembre 2015 à 20:21
-- Version du serveur: 5.5.46
-- Version de PHP: 5.5.30-1+deb.sury.org~precise+1
...
CREATE TABLE IF NOT EXISTS `admin` (
  ...
  `numTel` varchar(13) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `droit` enum('admin','user') CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT 'user',
...
INSERT INTO `admin` (`id_admin`, `username`, `password`, `email`, `nom`, `prenom`, `numTel`, `droit`) VALUES
(1, 'admin', 'admin', '', '', '', '', 'user'),
(2, 'abdoulaye', 'kamstelecom', '', '', '', '', 'user'),
(4, 'bassirou', 'passer', '', '', '', '', 'user');
...
CREATE TABLE IF NOT EXISTS `client` (
  ...
  `has_service` binary(1) NOT NULL DEFAULT '0',
...
INSERT INTO `client` (`client_id`, `client_UID`, `client_numTel`, `client_dateInsc`, `client_extCouv`, `client_UFR`, `client_adrMac`, `has_service`) VALUES
(10, '00010TH', '15', '2015-10-04 17:27:52', '', 'FST', '', '0'),
(12, '00012DK', '773675372', '2015-10-07 15:35:35', '', 'UGB', '', '0'),
(13, '00013DK', '+22177381', '2015-10-07 15:51:31', '', '', '', '0'),
(14, '00014SL', '773675377', '2015-10-08 00:34:40', '', '', '', '0'),
(15, '00015SL', '773675378', '2015-10-08 00:39:37', '', '', '', '0');
...
CREATE TABLE IF NOT EXISTS `tutoriel` (
  ...
  `tutoriel_dateDenvoie` datetime NOT NULL,
  `tutoriel_auteur` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `statut` enum('succes','attente','echec','pret') CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT 'attente',
  `tutoriel_confirm1` enum('0','1') CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '0',
  `tutoriel_confirm2` enum('0','1') CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '0',
...
INSERT INTO `tutoriel` (`tutoriel_id`, `tutoriel_entete`, `tutoriel_contenu`, `service_titre`, `tutoriel_dateDenvoie`, `tutoriel_auteur`, `statut`, `tutoriel_confirm1`, `tutoriel_confirm2`) VALUES
(2, 'nettoyer sa machine', 'Pour allumer une machine, il suffit de mettre appuyer sur le bouton d''allumage.', 'S1', '2015-12-03 20:20:00', 'abdoulaye', 'attente', '0', '0');
